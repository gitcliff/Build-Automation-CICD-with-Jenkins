...
Tasks included creating Jenkins pipeline jobs integrated with shared libraries, developing reusable Groovy functions for building jars and Docker images, managing GitLab repositories, and improving pipeline security and maintainability.
...
* **GitLab** ⚙️ – *Managed source code and Jenkins shared library repos*
